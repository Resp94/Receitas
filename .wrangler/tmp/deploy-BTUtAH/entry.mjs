...
const ASTRO_VERSION = "6.0.0-beta.15";
...
function generatePaginateFunction(routeMatch, base, trailingSlash) {
  return function paginateUtility(data, args2 = {}) {
...
class NodePool {
   ...
   */
  constructor(maxSize = 1e3, enableContentCache = false, enableStats = false) {
  ...
  acquire(type, content) {
    if (this.enableContentCache && content !== void 0 && (type === "text" || type === "html-string")) {
      ...
      const template2 = this.createNode(type, content);
      this.contentCache.set(cacheKey, template2);
      return this.cloneNode(template2);
    }
  ...
  warmCache(patterns) {
    ...
    for (const { type, content } of patterns) {
      ...
      if (!this.contentCache.has(cacheKey)) {
        const template2 = type === "text" ? { type: "text", content } : { type: "html-string", html: content };
        this.contentCache.set(cacheKey, template2);
      }
    }
  }
...
const COMMON_HTML_PATTERNS = [
  ...
  { type: "html-string", content: "</div>" },
  { type: "html-string", content: "<span>" },
  { type: "html-string", content: "</span>" },
  { type: "html-string", content: "<p>" },
  { type: "html-string", content: "</p>" },
  { type: "html-string", content: "<section>" },
  { type: "html-string", content: "</section>" },
  { type: "html-string", content: "<article>" },
  { type: "html-string", content: "</article>" },
  { type: "html-string", content: "<header>" },
  { type: "html-string", content: "</header>" },
  { type: "html-string", content: "<footer>" },
  { type: "html-string", content: "</footer>" },
  { type: "html-string", content: "<nav>" },
  { type: "html-string", content: "</nav>" },
  { type: "html-string", content: "<main>" },
  { type: "html-string", content: "</main>" },
  { type: "html-string", content: "<aside>" },
  { type: "html-string", content: "</aside>" },
  // List elements
  { type: "html-string", content: "<ul>" },
  { type: "html-string", content: "</ul>" },
  { type: "html-string", content: "<ol>" },
  { type: "html-string", content: "</ol>" },
  { type: "html-string", content: "<li>" },
  { type: "html-string", content: "</li>" },
  ...
  { type: "html-string", content: "<hr/>" },
  // Heading elements
  { type: "html-string", content: "<h1>" },
  { type: "html-string", content: "</h1>" },
  { type: "html-string", content: "<h2>" },
  { type: "html-string", content: "</h2>" },
  { type: "html-string", content: "<h3>" },
  { type: "html-string", content: "</h3>" },
  { type: "html-string", content: "<h4>" },
  { type: "html-string", content: "</h4>" },
  // Inline elements
  { type: "html-string", content: "<a>" },
  { type: "html-string", content: "</a>" },
  { type: "html-string", content: "<strong>" },
  { type: "html-string", content: "</strong>" },
  { type: "html-string", content: "<em>" },
  { type: "html-string", content: "</em>" },
  { type: "html-string", content: "<code>" },
  { type: "html-string", content: "</code>" },
  ...
  constructor(logger, manifest2, runtimeMode, renderers2, resolve, streaming, adapterName = manifest2.adapterName, clientDirectives = manifest2.clientDirectives, inlinedScripts = manifest2.inlinedScripts, compressHTML = manifest2.compressHTML, i18n = manifest2.i18n, middleware = manifest2.middleware, routeCache = new RouteCache(logger, runtimeMode), site = manifest2.site ? new URL(manifest2.site) : void 0, defaultRoutes = createDefaultRoutes(manifest2), actions = manifest2.actions, sessionDriver = manifest2.sessionDriver, serverIslands = manifest2.serverIslandMappings) {
    ...
    if (manifest2.experimentalQueuedRendering.enabled) {
      this.nodePool = this.createNodePool(
        ...
        manifest2.experimentalQueuedRendering.contentCache ?? false,
        false
      );
...
class Slots {
  ...
  async render(name, args2 = []) {
    ...
    if (!Array.isArray(args2)) {
      ...
      if (expression) {
        const slot = async () => typeof expression === "function" ? expression(...args2) : expression;
...
const _virtual_astro_adapterEntrypoint = void 0;
...
const _manifest = deserializeManifest({ "rootDir": "file:///C:/Users/respl/OneDrive/%C3%81rea%20de%20Trabalho/Sem%20codar/Antigravity/Receitas/", "cacheDir": "file:///C:/Users/respl/OneDrive/%C3%81rea%20de%20Trabalho/Sem%20codar/Antigravity/Receitas/node_modules/.astro/", "outDir": "file:///C:/Users/respl/OneDrive/%C3%81rea%20de%20Trabalho/Sem%20codar/Antigravity/Receitas/dist/", "srcDir": "file:///C:/Users/respl/OneDrive/%C3%81rea%20de%20Trabalho/Sem%20codar/Antigravity/Receitas/src/", "publicDir": "file:///C:/Users/respl/OneDrive/%C3%81rea%20de%20Trabalho/Sem%20codar/Antigravity/Receitas/public/", "buildClientDir": "file:///C:/Users/respl/OneDrive/%C3%81rea%20de%20Trabalho/Sem%20codar/Antigravity/Receitas/dist/", "buildServerDir": "file:///C:/Users/respl/OneDrive/%C3%81rea%20de%20Trabalho/Sem%20codar/Antigravity/Receitas/dist/_worker.js/", "adapterName": "@astrojs/cloudflare", "assetsDir": "_astro", "routes": [{ "file": "", "links": [], "scripts": [], "styles": [], "routeData": { "type": "page", "component": "_server-islands.astro", "params": ["name"], "segments": [[{ "content": "_server-islands", "dynamic": false, "spread": false }], [{ "content": "name", "dynamic": true, "spread": false }]], "pattern": "^\\/_server-islands\\/([^/]+?)\\/?$", "prerender": false, "isIndex": false, "fallbackRoutes": [], "route": "/_server-islands/[name]", "origin": "internal", "distURL": [], "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Layout.P5CnW-8r.css" }, { "type": "inline", "content": ".recipe-hero[data-astro-cid-zhuoy4lv]{position:relative;width:100%;margin-bottom:4rem}.hero-content[data-astro-cid-zhuoy4lv]{position:relative;max-width:1000px;margin:0 auto;padding-top:2rem}.hero-image-wrapper[data-astro-cid-zhuoy4lv]{position:relative;width:100%;height:400px;border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow-md)}.hero-image[data-astro-cid-zhuoy4lv]{width:100%;height:100%;object-fit:cover}.hero-overlay[data-astro-cid-zhuoy4lv]{position:absolute;inset:0;background:linear-gradient(to bottom,#0000 50%,#0009)}.hero-text-card[data-astro-cid-zhuoy4lv]{background:#fff;padding:2.5rem;border-radius:var(--radius-lg);box-shadow:var(--shadow-lg);max-width:80%;margin:-100px auto 0;position:relative;z-index:10;text-align:center}.recipe-title[data-astro-cid-zhuoy4lv]{font-size:2.5rem;color:var(--color-secondary);margin-bottom:1rem}.recipe-desc[data-astro-cid-zhuoy4lv]{font-size:1.125rem;color:#555;margin-bottom:2rem}.recipe-info[data-astro-cid-zhuoy4lv]{display:flex;justify-content:center;align-items:center;gap:2rem;padding-top:2rem;border-top:1px solid #eee}.info-item[data-astro-cid-zhuoy4lv]{display:flex;align-items:center;gap:1rem;text-align:left;color:var(--color-primary)}.info-divider[data-astro-cid-zhuoy4lv]{width:1px;height:40px;background-color:#e0e0e0}.info-label[data-astro-cid-zhuoy4lv]{display:block;font-size:.75rem;font-weight:700;color:#888;letter-spacing:1px}.info-value[data-astro-cid-zhuoy4lv]{display:block;font-size:1.125rem;font-weight:600;color:var(--color-text-body)}.recipe-content-wrapper[data-astro-cid-zhuoy4lv]{max-width:800px;margin:0 auto 6rem}.markdown-content[data-astro-cid-zhuoy4lv] h2{font-size:1.75rem;color:var(--color-secondary);margin-top:3rem;margin-bottom:1.5rem;padding-bottom:.5rem;border-bottom:2px solid #f0f0f0}.markdown-content[data-astro-cid-zhuoy4lv] ul,.markdown-content[data-astro-cid-zhuoy4lv] ol{margin-bottom:2rem;padding-left:1.5rem}.markdown-content[data-astro-cid-zhuoy4lv] li{margin-bottom:.75rem;line-height:1.8}.markdown-content[data-astro-cid-zhuoy4lv] ul li::marker{color:var(--color-primary)}.markdown-content[data-astro-cid-zhuoy4lv] strong{color:var(--color-secondary)}@media(max-width:768px){.hero-image-wrapper[data-astro-cid-zhuoy4lv]{border-radius:0;height:300px}.hero-content[data-astro-cid-zhuoy4lv]{padding-top:0}.hero-text-card[data-astro-cid-zhuoy4lv]{max-width:90%;padding:1.5rem}.recipe-title[data-astro-cid-zhuoy4lv]{font-size:2rem}.recipe-info[data-astro-cid-zhuoy4lv]{flex-direction:column;gap:1rem}.info-divider[data-astro-cid-zhuoy4lv]{display:none}}\n" }], "routeData": { "route": "/receitas/[id]", "isIndex": false, "type": "page", "pattern": "^\\/receitas\\/([^/]+?)\\/?$", "segments": [[{ "content": "receitas", "dynamic": false, "spread": false }], [{ "content": "id", "dynamic": true, "spread": false }]], "params": ["id"], "component": "src/pages/receitas/[id].astro", "prerender": true, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }, { "file": "", "links": [], "scripts": [], "styles": [{ "type": "external", "src": "_astro/Layout.P5CnW-8r.css" }, { "type": "inline", "content": ".hero-section[data-astro-cid-j7pv25f6]{padding:6rem 0 4rem;background:linear-gradient(to bottom,#fff,#fef5f2)}.hero-title[data-astro-cid-j7pv25f6]{font-size:3.5rem;color:var(--color-text-body);margin-bottom:1rem}.highlight[data-astro-cid-j7pv25f6]{color:var(--color-primary)}.hero-subtitle[data-astro-cid-j7pv25f6]{font-size:1.25rem;color:#666;max-width:600px;margin:0 auto}.categories[data-astro-cid-j7pv25f6]{display:flex;justify-content:center;gap:1rem;flex-wrap:wrap}.bg-gray[data-astro-cid-j7pv25f6]{background-color:#fcfcfc;padding:4rem 0}.recipes-grid[data-astro-cid-j7pv25f6]{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:2rem}@media(max-width:768px){.hero-title[data-astro-cid-j7pv25f6]{font-size:2.5rem}}\n" }], "routeData": { "route": "/", "isIndex": true, "type": "page", "pattern": "^\\/$", "segments": [], "params": [], "component": "src/pages/index.astro", "pathname": "/", "prerender": true, "fallbackRoutes": [], "distURL": [], "origin": "project", "_meta": { "trailingSlash": "ignore" } } }], "serverLike": true, "base": "/", "trailingSlash": "ignore", "compressHTML": true, "experimentalQueuedRendering": { "enabled": false, "poolSize": 0, "contentCache": false }, "componentMetadata": [["\0astro:content", { "propagation": "in-tree", "containsHead": false }], ["C:/Users/respl/OneDrive/Área de Trabalho/Sem codar/Antigravity/Receitas/src/pages/index.astro", { "propagation": "in-tree", "containsHead": true }], ["\0virtual:astro:page:src/pages/index@_@astro", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:pages", { "propagation": "in-tree", "containsHead": false }], ["\0virtual:astro:manifest", { "propagation": "in-tree", "containsHead": false }], ["C:/Users/respl/OneDrive/Área de Trabalho/Sem codar/Antigravity/Receitas/node_modules/astro/dist/entrypoints/prerender.js", { "propagation": "in-tree", "containsHead": false }], ["C:/Users/respl/OneDrive/Área de Trabalho/Sem codar/Antigravity/Receitas/src/pages/receitas/[id].astro", { "propagation": "in-tree", "containsHead": true }], ["\0virtual:astro:page:src/pages/receitas/[id]@_@astro", { "propagation": "in-tree", "containsHead": false }]], "renderers": [], "clientDirectives": [["idle", '(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value=="object"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};"requestIdleCallback"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event("astro:idle"));})();'], ["load", '(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event("astro:load"));})();'], ["media", '(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener("change",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event("astro:media"));})();'], ["only", '(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event("astro:only"));})();'], ["visible", '(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value=="object"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event("astro:visible"));})();']], "entryModules": { "virtual:astro:legacy-ssr-entry": "index.js", "\0virtual:astro:actions/noop-entrypoint": "chunks/noop-entrypoint_ntO3dYp_.mjs", "\0virtual:astro:middleware": "chunks/_virtual_astro_middleware_CsxkL0LN.mjs", "\0virtual:astro:session-driver": "chunks/_virtual_astro_session-driver_x9Ra2-EZ.mjs", "\0virtual:astro:server-island-manifest": "chunks/_virtual_astro_server-island-manifest_Bcr5fJ-E.mjs", "\0virtual:astro:page:src/pages/receitas/[id]@_@astro": "chunks/_id__3DHk9Lz0.mjs", "\0virtual:astro:page:src/pages/index@_@astro": "chunks/index_DETYI6DE.mjs", "C:\\Users\\respl\\OneDrive\\Área de Trabalho\\Sem codar\\Antigravity\\Receitas\\.astro\\content-assets.mjs": "chunks/content-assets_XqCgPAV2.mjs", "C:\\Users\\respl\\OneDrive\\Área de Trabalho\\Sem codar\\Antigravity\\Receitas\\.astro\\content-modules.mjs": "chunks/content-modules_Bvq7llv8.mjs", "\0astro:data-layer-content": "chunks/_astro_data-layer-content_Cnzs282f.mjs", "C:/Users/respl/OneDrive/Área de Trabalho/Sem codar/Antigravity/Receitas/node_modules/astro/dist/assets/services/sharp.js": "chunks/sharp_g5DTrnJc.mjs", "C:/Users/respl/OneDrive/Área de Trabalho/Sem codar/Antigravity/Receitas/node_modules/astro/dist/entrypoints/prerender.js": "prerender-entry.BPmBM_s3.mjs", "C:/Users/respl/OneDrive/Área de Trabalho/Sem codar/Antigravity/Receitas/src/pages/index.astro?astro&type=script&index=0&lang.ts": "_astro/index.astro_astro_type_script_index_0_lang.DfnifyMS.js", "astro:scripts/before-hydration.js": "" }, "inlinedScripts": [["C:/Users/respl/OneDrive/Área de Trabalho/Sem codar/Antigravity/Receitas/src/pages/index.astro?astro&type=script&index=0&lang.ts", 'globalThis.process??={};globalThis.process.env??={};document.addEventListener("DOMContentLoaded",()=>{const r=document.querySelectorAll(".category-btn"),o=document.getElementById("searchInput"),l=document.querySelectorAll(".recipe-card");let a="all",c="";function s(){l.forEach(e=>{const t=e,n=e.getAttribute("data-tags");n&&n.split(",");const d=t.querySelector(".badge:not([style])")?.textContent?.trim()||"",i=t.querySelector(".recipe-card-title")?.textContent?.toLowerCase()||"",u=a==="all"||d===a,y=!c||i.includes(c);u&&y?t.style.display="block":t.style.display="none"})}o&&o.addEventListener("input",e=>{c=e.target.value.toLowerCase(),s()}),r.forEach(e=>{e.addEventListener("click",()=>{a=e.getAttribute("data-category"),r.forEach(t=>t.classList.remove("active")),e.classList.add("active"),s()})})});']], "assets": ["/favicon.ico", "/favicon.svg", "/index.html", "/images/bolo-de-cenoura.png", "/images/estrogonofe-carne.png", "/images/frango-xadrez.png", "/images/hamburguer-caseiro.png", "/images/lasanha-bolonhesa.png", "/images/maminha.png", "/images/peixe-grelhado.png", "/images/risoto-cogumelos.png", "/images/salada-caesar.png", "/images/sopa-lentilha.png", "/images/tacos-mexicanos.png", "/images/torta-limao.png", "/_worker.js/index.js", "/_astro/Layout.P5CnW-8r.css", "/receitas/bolo-de-cenoura/index.html", "/receitas/estrogonofe-carne/index.html", "/receitas/frango-xadrez/index.html", "/receitas/hamburguer-caseiro/index.html", "/receitas/lasanha-bolonhesa/index.html", "/receitas/maminha-assada/index.html", "/receitas/peixe-grelhado/index.html", "/receitas/risoto-cogumelos/index.html", "/receitas/salada-caesar/index.html", "/receitas/tacos-mexicanos/index.html", "/receitas/sopa-lentilha/index.html", "/receitas/torta-limao/index.html", "/index.html"], "buildFormat": "directory", "checkOrigin": true, "allowedDomains": [], "key": "YfTr6yX0zICieeIvywGupzMn9FJpUFwUHqjKRhmz0CY=", "sessionConfig": { "driver": "unstorage/drivers/cloudflare-kv-binding" }, "image": {}, "devToolbar": { "enabled": false, "debugInfoOutput": "" }, "logLevel": "info", "shouldInjectCspMetaTags": false });
...
const workerEntry = _virtual_astro_legacySsrEntry ?? {};
export {
